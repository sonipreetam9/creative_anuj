        ...
        <div class="swiper-slider" data-autoplay="true" data-loop="true" data-dots="false" data-arrows="true" data-columns="1"
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="pbmit-slider-item">
                        <div class="pbmit-slider-bg"
                            style="background-image: url({{ asset('assets/images/banner-slider-img/11slide-1.jpg') }});">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="pbmit-slider-item">
                        <div class="pbmit-slider-bg"
                            style="background-image: url({{ asset('assets/images/banner-slider-img/11slide-2.jpg') }});">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8 col-lg-6">
                ...
                <div class="swiper-slide">
                    <div class="pbmit-slider-item">
                        <div class="pbmit-slider-bg"
                            style="background-image: url({{ asset('assets/images/banner-slider-img/11slide-3.jpg') }});">
                        </div>
                        <div class="container">
                            <div class="row">
                ...
                <div class="swiper-slide">
                    <div class="pbmit-slider-item">
                        <div class="pbmit-slider-bg"
                            style="background-image: url({{ asset('assets/images/banner-slider-img/11slide-4.jpg') }});">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-lg-8">
                                        ...
                                        <div class="pbminfotech-box-content">
                                            ...
                                            <div class="pbminfotech-box-content-inner">
                                                <div class="pbminfotech-box-author">
                                                    ...
                                                    <div class="pbminfotech-testimonial-detail">Entrepreneur –
                                                        Multi-service Client</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
